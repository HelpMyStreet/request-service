...
namespace RequestService.Core.Interfaces.Repositories
{
    public interface IRepository
    {
        ...
        Task<UpdateJobStatusOutcome> UpdateJobStatusToApprovedAsync(int jobID, int createdByUserID, CancellationToken cancellationToken);
        Task<UpdateJobStatusOutcome> UpdateJobStatusToRejectedAsync(int jobID, int createdByUserID, CancellationToken cancellationToken);
