...
{
    public class PutUpdateJobStatusToAcceptedHandlerTests
    {
        private Mock<IRepository> _repository;
        private Mock<IJobService> _jobService;
        private Mock<ICommunicationService> _communicationService;
        private PutUpdateJobStatusToAcceptedHandler _classUnderTest;
        private PutUpdateJobStatusToAcceptedRequest _request;
        ...
        public void Setup()
        {
            ...
            _classUnderTest = new PutUpdateJobStatusToAcceptedHandler(_repository.Object, _jobService.Object, _communicationService.Object);
        }
        ...
        private void SetupRepository()
        {
            ...
            _repository.Setup(x => x.UpdateJobStatusAcceptedAsync(
                It.IsAny<int>(), 
                It.IsAny<int>(),
                It.IsAny<int>(),
        ...
        public async Task WhenSuccessfullyChangingJobStatusToAccepted_ReturnsTrue()
        {
            ...
            _request = new PutUpdateJobStatusToAcceptedRequest
            {
                CreatedByUserID = 1,
                JobID = 1,
                VolunteerUserID = 1
            ...
            _repository.Verify(x => x.UpdateJobStatusAcceptedAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<CancellationToken>()), Times.Once);
        ...
        public async Task WhenVolunteerDoesNotHavePermission_ReturnsUnauthorised()
        {
            ...
            var response = await _classUnderTest.Handle(_request, CancellationToken.None);
            _repository.Verify(x => x.JobHasStatus(It.IsAny<int>(), It.IsAny<JobStatuses>()), Times.Once);
            _repository.Verify(x => x.UpdateJobStatusAcceptedAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<CancellationToken>()), Times.Never);
            _communicationService.Verify(x => x.RequestCommunication(It.IsAny<RequestCommunicationRequest>(), It.IsAny<CancellationToken>()), Times.Never);
